...
const easyScen = [
  ...
  },
  {
    ...
    challengeType: "easy",
    backgroundImg:
      "https://drive.google.com/file/d/1QayHDYh-cRJp7oROEKupxOZlNeUon2qS/view?usp=sharing",
    description:
      "After man days and nights on your voyage to safety, you come to a massive wall of rock. The wall stretches to the horizon in both directions and darn near to the sun above you. After further investigation you find the entrance to what seems to be an expansive cave system. All of your experience with caves rightfully makes you hesitate to walk straight in, but you know that where you need to go to reach safety is on the other side of this wall. Do you brave the cave or do you try to find to climb over the wall?",
...
const normalScen = [
  ...
  },
  {
    ...
    challengeType: "normal",
    backgroundImg:
      "https://drive.google.com/file/d/1ihbNnVKL2E1p3UfE0tg7ot8YYrZ6sPrd/view?usp=sharing",
    description:
      "You have not eaten in days. As a matter of fact, you have no recollection of even seeing a food thing in the last few days. You stumble quietly (and hungry, duh) up to a small camp. Around a pretty fire you see three wanderers the size of apex predators having a tea party while your body weight in meat slowly cooks over the flames. They have food, you do not. You are starving but they are huge. Eating is quickly become a necessity for you so you have to decide whether to try and steal some of their bounty or try your luck at hunting for food that seemingly no longer exists.",
    choices: [
      "Steal Food from the Big Scary Trio",
      "Take your chances hunting for yourself",
    ],
  },
  {
    id: 3,
...
const hardScen = [
  ...
  },
  {
    ...
    challengeType: "hard",
    backgroundImg:
      "https://drive.google.com/file/d/13j6K28zT9PEVpDPC91oPQ2UR8kN8LBZN/view?usp=sharing",
    description:
